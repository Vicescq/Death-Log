...
export default function Card<T>({ objContext, onDelete, onDeath, onReadOnly }: { objContext: Collection<T>, onDelete: () => void, onDeath: ((deathType: DeathType) => void) | null, onReadOnly: (() => void) | null}) {
    ...
    function subjectBtns() {
        return (
            <>
                ...
                <button onClick={() => onReadOnly!()} className="border-2 p-1 border-red-400 rounded-lg bg-red-400">✓</button>
            </>
